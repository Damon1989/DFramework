...
namespace MyMvcTest.Helper
{
    ...
    public class TravelApplyPdfModel
    {
        ...
        /// 申请人
        /// </summary>
        [Description("1,0!3,Applicant,申请人!3,40")]
        public string Applicant { get; set; }
        /// <summary>
        /// 申请部门
        /// </summary>
        [Description("1,3!3,ApplyDept,申请部门!3,40")]
        public string  ApplyDept { get; set; }
        /// <summary>
        /// 收款人
        /// </summary>
        [Description("2,0!3,Receiver,收款人!3,40")]
        public string Receiver { get; set; }
        /// <summary>
        /// 收款账号
        /// </summary>
        [Description("2,3!3,PaymentAccount,收款账号!3,40")]
        public string PaymentAccount { get; set; }
        /// <summary>
        /// 事由
        /// </summary>
        [Description("3,0!6,Remark!3,40")]
        public string Remark { get; set; }
        /// <summary>
        /// 事由内容
        /// </summary>
        [Description("4,0!6,RemarkInfo!3,40")]
        public string RemarkInfo { get; set; }

        /// <summary>
        /// 入账信息
        /// </summary>
        [Description("5,0!6,AccountingInfo!3,40")]
        public string AccountingInfo { get; set; }
        /// <summary>
        /// 入账部门
        /// </summary>
        [Description("6,0!6,AccountingDept,入账部门!3,40")]
        public string AccountingDept { get; set; }
        /// <summary>
        /// 入账项目
        /// </summary>
        [Description("7,0!6,AccountingProject,入账项目!3,40")]
        public string AccountingProject { get; set; }
        /// <summary>
        /// 业务类型
        /// </summary>
        [Description("8,0!6,BusinessType,业务类型!3,40")]
        public string BusinessType { get; set; }

        /// <summary>
        /// 出差路线
        /// </summary>
        [Description("9,0!6,TravelRouteList,出差路线,list!3,40")]
        public List<TravelRoute> TravelRouteList { get; set; }

        /// <summary>
        /// 出差申请费用预算
        /// </summary>
        [Description("10,0!6,CostBudgetList,出差申请费用预算,list!3,40")]
        public List<CostBudget> CostBudgetList { get; set; }
        /// <summary>
        /// 审批信息
        /// </summary>
        [Description("11,0!6,ApproveInfoList,审批信息,list!3,40")]
        public List<ApproveInfo> ApproveInfoList { get; set; }
        ///// <summary>
        ///// 签字确认
        ///// </summary>
        //[Description("12,0!6,SignConfirm,!3,40")]
        //public string SignConfirm { get; set; }

        ///// <summary>
        ///// 提交人
        ///// </summary>
        //[Description("13,0!3,Submitter,!3,40")]
        //public string Submitter { get; set; }
        ///// <summary>
        ///// 提交日期
        ///// </summary>
        //[Description("13,3!3,SubmitDate,!3,40")]
        //public string SubmitDate { get; set; }

        ///// <summary>
        ///// 币种
        ///// </summary>
        //[Description("6,0!6,Currency,币种!3,40")]
        //public string Currency { get; set; }
    }

    public class TravelRoute
    {
        [Description("0,1!StartTime,出发时间!3,40")]
        public string StartTime { get; set; }
        [Description("1,1!StartPlace,出发地点!3,40")]
        public string StartPlace { get; set; }
        [Description("2,1!EndTime,结束时间!3,40")]
        public string EndTime { get; set; }
        [Description("3,1!TravelCity,出差城市!3,40")]
        public string TravelCity { get; set; }
        [Description("4,1!TravelWay,出行方式!3,40")]
        public string TravelWay { get; set; }
        [Description("5,1!Accommodation,住宿!3,40")]
    ...
    public class CostBudget
    {
        ...
        /// 币种
        /// </summary>
        [Description("0,2!Currency,币种!3,40")]
        public string Currency { get; set; }
        /// <summary>
        /// 费用项目
        /// </summary>
        [Description("2,2!CostProject,费用项目!3,40")]
        public string CostProject { get; set; }
        /// <summary>
        /// 申请金额
        /// </summary>
        [Description("4,2!ApplyAmount,申请金额!3,40")]

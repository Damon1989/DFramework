...
namespace Abp.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        ///  Indicates whether this string is null or System.String.Empty string.
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        ...
        /// <returns>Modifies string or the same string if it has not any of given postfixes</returns>
        ...
        /// <summary>
        ///  Gets s substring of a string from beginning of the string if it exceeds maximum length
        /// </summary>
        /// <param name="str"></param>

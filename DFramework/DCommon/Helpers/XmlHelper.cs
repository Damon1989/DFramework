namespace DCommon
{
    ...
    public class XmlHelper
    {
        ...
        public static string[] GetXmlElementNameArray(string xmlFilePath)
        {
            ...
            if (rootNode == null) return new string[0];
            var array = new List<string>();
            for (var i = 0; i < rootNode.ChildNodes.Count; i++) array.Add(rootNode.ChildNodes[i].Name);
        ...
        public static string GetXmlElementValue(XmlElement rootNode, string xmlName)
        {
            ...
            {
                if (!rootNode.ChildNodes[i].Name.Equals(xmlName, StringComparison.OrdinalIgnoreCase)) continue;

namespace DCommon
{
    ...
    public class CookieHelper
    {
        ...
        public static HttpCookie GetCookie(string cookieName)
        {
            ...
            if (request != null) return request.Cookies[cookieName];
            return null;
        }
        ...
        {
            var request = HttpContext.Current.Request;
            if (request != null) return GetCookieValue(request.Cookies[cookieName], key);
            return string.Empty;
        }
        ...
        public static string GetCookieValue(HttpCookie cookie, string key)
        {
            if (cookie != null)
            {
                if (!string.IsNullOrEmpty(key) && cookie.HasKeys) return cookie.Values[key];
                return cookie.Value;
            }
        ...
        public static void SetCookie(string cookieName, string key, string value, DateTime? expires)
        {
            ...
            if (response != null)
            {
                ...
                if (cookie != null)
                {
                    if (!string.IsNullOrEmpty(key) && cookie.HasKeys) cookie.Values.Add(key, value);
                    else if (!string.IsNullOrEmpty(value)) cookie.Value = value;

namespace DFramework.Repositories
{
    ...
    {
        public static IQueryable<TEntity> MergeOrderExpresion<TEntity>(
            ...
            bool hasSorted = false)
        {
            ...
            else orderByCmd = orderExpression.SortOrder == SortOrder.Descending ? "OrderByDescending" : "OrderBy";
            ...
            if (orderExpression is OrderExpression<TEntity>)
            {
                ...
                if (member is UnaryExpression) member = (member as UnaryExpression).Operand;
